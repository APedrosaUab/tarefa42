        ...
        <b-col>
          <b-card class="overflow-hidden" style="max-width: 1540px; ">
            <b-row>
              ...
              <b-col md="6">
                <b-card-body :title="sponsor.name + ' (' + sponsor.group + ')'">
                  ...
                  <b-card-text>
                    ...
                    <b-alert
                      show
                      variant="secondary"
                      v-for="comment in this.sponsor.comments"
                      :key="comment._id"
                    >
                  ...
                  <b-card-text>
                    ...
                    <div class="form-group">
                      ...
                      <b-button
                        ...
                        class="mr-2"
                        @click="showVideo(sponsor.links[1].url)"
                      >
