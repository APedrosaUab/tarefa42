        ...
        <b-col>
          <b-card class="overflow-hidden" style="max-width: 1540px; ">
            <b-row>
              ...
              <b-col md="6">
                <b-card-body :title="expert.name + ' (' + expert.group + ')'">
                  ...
                  <b-card-text>
                    ...
                    <b-alert
                      show
                      variant="secondary"
                      v-for="comment in this.expert.comments"
                      :key="comment._id"
                    >
                  ...
                  <b-card-text>
                    ...
                    <div class="form-group">
                      ...
                      <b-button
                        ...
                        class="mr-2"
                        @click="showVideo(expert.links[1].url)"
                      >
